...
help: ## Show this help
	...
	@echo
	@echo "  smoke takes S=<scenario>: hops (default), train, occupied, night, skies, skid, debug, battle, halt, halt-crash, perks, perks2, barrier, powerups, powerups2, logo, poses, burn, phone, tablet, freight, maze, shots"
